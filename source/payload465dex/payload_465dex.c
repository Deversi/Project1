...
void load_payload_465dex (int mode)
{
    ...
    {
        pokeq(0x80000000002A7230ULL, 0x4E80002038600000ULL ); // fix 8001003C error  Original: 0x4E80002038600000ULL
        pokeq(0x80000000002A7238ULL, 0x7C6307B44E800020ULL ); // fix 8001003C error  Original: 0x7C6307B44E800020ULL
    ...
    { // disable new patches
        pokeq(0x800000000005C780ULL +  0, 0x419E0038E8610098ULL);
        pokeq(0x800000000005C780ULL +  8, 0x2FA30000419E000CULL);
        pokeq(0x800000000005C780ULL + 16, 0x388000334800BE15ULL);
        pokeq(0x800000000005C780ULL + 24, 0xE80100F07FE307B4ULL);

        pokeq(0x800000000005962CULL +  0, 0xF821FE917C0802A6ULL);
        pokeq(0x800000000005962CULL +  8, 0xFBC10160FBE10168ULL);
        pokeq(0x800000000005962CULL + 16, 0xFB610148FB810150ULL);
        pokeq(0x800000000005962CULL + 24, 0xFBA10158F8010180ULL);
    }
