...
void load_payload_465(int mode)
{
    ...
    {
        pokeq(0x80000000002925E4ULL, 0x4E80002038600000ULL ); // fix 8001003C error  Original: 0x4E80002038600000ULL
        pokeq(0x80000000002925ECULL, 0x7C6307B44E800020ULL ); // fix 8001003C error  Original: 0x7C6307B44E800020ULL
    ...
    { // disable new habib patches
        pokeq(0x8000000000058DB0ULL +  0, 0x419E0038E8610098ULL);
        pokeq(0x8000000000058DB0ULL +  8, 0x2FA30000419E000CULL);
        pokeq(0x8000000000058DB0ULL + 16, 0x388000334800BE15ULL);
        pokeq(0x8000000000058DB0ULL + 24, 0xE80100F07FE307B4ULL);
